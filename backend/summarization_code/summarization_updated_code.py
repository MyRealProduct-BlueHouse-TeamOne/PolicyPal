# Google colab: https://colab.research.google.com/drive/19TrzFEpF4jpC0D5X_OjgQIr6QtMJ1O53?usp=sharing
...
def summarize_text(text, max_length=1024):
    """Summarizes the given text using chunking if necessary."""
    ...
    # We may need to use this code below in future to make the summaries even shorter
...
You can delete individual content that you share, post and upload at any time. In addition, all content posted to your personal account will be deleted if you delete your account. Learn more about how to delete your account. Account deletion does not automatically delete content that you post as an admin of a Page or content that you create collectively with other users, such as photos in Shared Albums that may continue to be visible to other album members.
...
Community Standards: These guidelines outline our standards regarding the content that you post to Facebook and your activity on Facebook and other Meta Products.
...
"""
final_summary = summarize_text(long_text, max_length=512)
print(final_summary)

# Uncomment the code below to see how the output looks in separate sentences/paragraphs
